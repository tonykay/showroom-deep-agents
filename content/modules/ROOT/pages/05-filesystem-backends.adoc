...
total 16
drwxr-xr-x  4 user  staff  128 Apr 04 10:15 .
drwxr-xr-x  8 user  staff  256 Apr 04 10:10 ..
drwxr-xr-x  4 user  staff  128 Apr 04 10:12 myproject
----

The agent ran real shell commands and captured their output. `LocalShellBackend` gives the agent everything `FilesystemBackend` has (file read/write/edit) plus the `execute` tool for shell commands. This enables workflows like running tests, checking dependencies, or inspecting build artifacts.
