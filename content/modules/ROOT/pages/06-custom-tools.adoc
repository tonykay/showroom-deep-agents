...
[source,role="execute"]
----
uv run python structured_tool.py
----
+
.Sample output
----
...
[source,role="execute"]
----
uv run python multiple_tools.py
----
+
.Sample output
----
...
[source,role="execute"]
----
uv run python interrupt_tool.py
----
+
.Sample output
----
