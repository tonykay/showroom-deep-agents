...
Create a code review skill. First, make the directory structure:
...
Now create the skill definition:
...
Now register the skill with your agent:
...
Observe progressive disclosure in action. Try two different requests:
...
Now register both skill sources:
