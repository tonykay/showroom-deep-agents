...
TIP: A complete reference implementation for this capstone is available in `solutions/capstone/` in the workshop repository. Use it to check your work or get unstuck — but you'll learn more by building it yourself.
