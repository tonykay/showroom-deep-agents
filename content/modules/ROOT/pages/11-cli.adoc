...
* **Keyboard shortcuts** — use arrow keys for navigation, Enter to submit, Ctrl+C to exit

Now give the CLI a multi-step task that requires planning and tool usage.
...
Exit the CLI with Ctrl+C when you're done exploring.
...
1. **Scaffold a new feature**: "Create a new module called `feature_analytics.py` that provides basic analytics for user interactions"

2. **Write tests**: "Now write comprehensive tests for the analytics module you just created"

3. **Review the code**: "Review the analytics module code you wrote and identify any potential improvements"

4. **Update memory**: "Update AGENTS.md with what you learned about analytics implementation in this project"
