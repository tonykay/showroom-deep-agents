...
Deep Agents uses a `"provider:model"` format that supports any LiteLLM-compatible provider. If you want to use a different model, just change this one line. Here are some examples:
...
For example, to run the entire workshop against a local Ollama model:
